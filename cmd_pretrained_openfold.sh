python3 run_pretrained_openfold.py \
        ...
        --model_device 'cuda:0' \
        --jackhmmer_binary_path /opt/anaconda3/envs/openfold_venv/bin/jackhmmer \
        --hhblits_binary_path /opt/anaconda3/envs/openfold_venv/bin/hhblits \
        --hhsearch_binary_path /opt/anaconda3/envs/openfold_venv/bin/hhsearch \
        --kalign_binary_path /opt/anaconda3/envs/openfold_venv/bin/kalign \
